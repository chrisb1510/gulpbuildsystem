...
describe('Browser', function () {
    ...
    it('should generate a header then successfully parse it (configuration)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-src-data' }).field;
    ...
    it('should generate a header then successfully parse it (node request)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var reqHeader = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-src-data', payload: payload, contentType: req.headers['content-type'] });
    ...
    it('should generate a header with stale ts and successfully authenticate on second call', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            var header = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-src-data' });
    ...
    it('should generate a header then successfully parse it (with hash)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, payload: 'hola!', ext: 'some-src-data' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('should generate a header then successfully parse it (src)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-src-data', app: 'asd23ased' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
    ...
    it('should generate a header then successfully parse it (src, dlg)', function (done) {
        ...
        credentialsFunc('123456', function (err, credentials) {
            ...
            req.authorization = Browser.client.header('http://example.com:8080/resource/4?filter=a', req.method, { credentials: credentials, ext: 'some-src-data', app: 'asd23ased', dlg: '23434szr3q4d' }).field;
            Hawk.server.authenticate(req, credentialsFunc, {}, function (err, credentials, artifacts) {
